...
func NewServerConfig(ctx context.Context, o opts.Options) (*Config, error) {
	...
	if !o.Etcd {
		...
		dbconfig = &db.PostgresConfig{
			Host: o.DBHost, Port: o.DBPort, User: o.DBUser, Password: o.DBPassword,
			DBname: o.DBName, SSLMode: o.DBSSLMode, SSLRootCert: o.DBSSLRootCert,
			SSLKey: o.DBSSLKey, SSLCert: o.DBSSLCert,
		}
	}
